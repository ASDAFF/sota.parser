...
$MESS ['parser_selector_hl_product'] = "Селектор товара в файле:";
$MESS ['parser_rss'] = "RSS канал:";
$MESS ["parser_selector_preview_id_xml"] = "Селектор-атрибут, содержащий id товара:";
$MESS ["parser_field_id_csv"] = "Индекс поля, содержащего id товара:";
$MESS ["parser_field_id_csv_descr"] = "Например: 0";
$MESS ["parser_selector_id_xml_descr"] = "Если пусто, то товары выгружаться не будут. Например: id, [id]";
$MESS["parser_highloadblock_not_exists"] = "Отсутствует модуль 'highloadblock'";
$MESS["parser_highloadblock_not_exists_id"] = "Отсутствует highload-блок";
$MESS["parser_dir_not_exists"] = "Отстутствует дериктория";
$MESS ['parser_highload_block_tab'] = "Настройки HL-block'a";
$MESS ['parser_rss_page'] = "URL страницы:";
$MESS ['parser_rss_catalog'] = "URL раздела каталога:";
$MESS ['parser_xml_catalog'] = "URL XML файла:";
$MESS ['parser_csv_catalog'] = "URL CSV файла:";
...
$MESS ['parser_name_descr_csv'] = "Если необходимо составить наименование из нескольких частей, то укажите индексы полей через \",\". Например: 0, 1, 5";
...
$MESS ['parser_preview_first_img_catalog_csv'] = "Индекс поля, содержащего ссылку на превью картинку:";
$MESS ['parser_detail_first_img_catalog_csv'] = "Индекс поля, содержащего ссылку на детальную картинку:";
...
$MESS ['parser_sleep_descr_csv'] = "Некоторые сайты осуществляют контроль активности, то есть, если количество обращений к сайту за единицу времени будет более установленного значения, то пользователь будет блокирован. Для обхода данной защиты установите временные задержки между обращениями парсера к сайту. Актуальна только при удаленном размещении CSV файла.";
...
$MESS ['parser_fields_id'] = "Выбор поле из списка";
...
$MESS ['parser_xml_text_preview_selector'] = "Селектор-атрибут превью описания:";
$MESS ['parser_xml_text_description_selector'] = "Селектор-атрибут детальное описания:";
$MESS ['parser_csv_text_selector'] = "Индекс поля, содержашего описание:";
...
$MESS ['parser_procurement_price'] = "Селектор закупочной цены ";
$MESS ['parser_preview_count'] = "Селектор количества:";
$MESS ['parser_preview_count_xml'] = "Селектор-атрибут количества:";
$MESS ['parser_preview_count_csv'] = "Индекс поля, содержащего количества:";
$MESS ['parser_preview_count_descr'] = "Если ничего не задано, то количество будет парсится из детальной страницы. Если оба поля заполнены, то предпочтение отдается детальной странице. <br> Если количество товара задается информерами, то соответствия заполняются в разделе \"Работа с информерами наличия\" во вкладке \"Торговый каталог\"";

$MESS ['parser_preview_count_xml_descr'] = "Если ничего не задано, то количество будет браться из вкладки \"Торговый каталог\" <br> Если количество товара задается информерами, то соответствия заполняются в разделе \"Работа с информерами наличия\" во вкладке \"Торговый каталог\"";
$MESS ['parser_preview_text_csv_descr'] = "Если необходимо объеденить несколько полей, то введите их индексы через \",\". Например \"1, 2, 3\"";

$MESS ['parser_detail_count'] = "Селектор количества:";
$MESS ['parser_detail_count_descr'] = "Если ничего не задано, то количество будет парсится из \"Превью\". Если оба поля заполнены, то предпочтение отдается детальной странице.<br> Если количество товара задается информерами, то соответствия заполняются в разделе \"Работа с информерами наличия\" во вкладке \"Торговый каталог\"";

$MESS ['parser_preview_price_xml'] = "Селектор-атрибут цены:";
$MESS ['parser_preview_price_csv'] = "Индекс поля, содержащего цену:";
$MESS ['parser_delimiter_image_csv'] = "Разделитель между ссылками на изображения:";
$MESS ['parser_delimiter_size_csv'] = "Разделитель между размерами:";
$MESS ['parser_delimiter_image_csv_descr'] ="Если ничего не задано, то считается, что в качестве разделителя ссылок используется \",\".";
$MESS ['parser_delimiter_size_csv_descr'] ="Если ничего не задано, то считается, что в качестве разделителя размеров используется \",\".";
...
$MESS ['parser_name_catalog_csv'] = "Индекс поля, содержащего названия товара:";
...
$MESS ['parser_size_selector_csv'] = "Парсинг размеров по индексу";
...
$MESS ['parser_selector_find_csv'] = "Индекс перечисления размеров:";
...
$MESS ['parser_selector_more_image_csv'] = "Индекс перечисления доп. картинок:";
...
$MESS ['parser_selector_props_csv'] = "Парсинг свойств по индексу";
...
$MESS ['parser_uniq_descr_csv'] = "По умолчанию при выгрузке товаров заполняется внешний код XML_ID элемента, как md5(название). Далее при обновлении уникализация осуществляется именно по внешнему коду. <br/><br /><b>Внимание! Если вы не хотите делать запись во внешний код и уникализировать по нему товар, то укажите, по какому полю производить уникализацию элементов. В этом случае внешний код XML_ID затираться не будет.</b>";
$MESS ['parser_isset_header_csv'] = "Первая строка содержит имена полей:";
$MESS ['parser_type_string'] = "[S]-строка";
$MESS ['parser_category_description'] = "Категории";
$MESS ['parser_offer_description'] = "Товары";
$MESS ['parser_delimiter_description'] = "Разделители";
$MESS ['parser_delimiter_csv'] = "Разделитель полей:";
$MESS ['parser_delimiter_csv_descr'] = "Если ничего не задано, то считается, что в качестве разделителя полей используется \";\".";
$MESS ['parser_first_field_name_descr'] = "Если первая строка файла представлят собой шапку, то установите данное значение.";
$MESS ['parser_mode'] = "Режим парсера:";
$MESS ['parser_mode_descr'] = "При debug режиме осуществляется парсинг первых 3 страниц и 3 товаров каждой страницы. Debug режим необходим для отладки парсера. В рабочий режим парсер необходимо переводить, если вы полностью отладили и настроили парсинг!!!";

$MESS ['parser_header_uniq'] = "Проверка уникальности";
$MESS ['parser_header_uniq_category'] = "Проверка уникальности категорий";
$MESS ['parser_uniq_name_category'] = "Название категории:";
$MESS ['parser_uniq_dop_fields_category'] = "Дополнительные поля:";

$MESS ['parser_select_uniq_category'] = "Выбор из списка";
$MESS ['parser_select_uniq_category_id'] = "ID категории из файла";
$MESS ['parser_select_uniq_category_file'] = "ID категории из файла + Ссылка на XML файл";
$MESS ['parser_select_uniq_category_file_csv'] = "ID категории из файла + Ссылка на CSV файл";
$MESS ['parser_select_uniq_category_parser_id'] = "ID категории из файла + ID парсера";
$MESS ['parser_uniq_category_descr_xml'] = "По умолчанию при выгрузке категорий заполняется XML_ID или Доп. поле категории(в зависимости от того, что установлено на вкладке \"Основные настройки\" в параметре \"Записывать id категории в\"), как shs_ + md5(от ссылки на файл)+_+id категории из файла. <br /><br />Если вы хотите уникализировать категории по другим параметрам - то выберите их в данной настройке.";
...
$MESS ['parser_catalog_count_default_csv_descr'] = "Поле должно иметь целое числовое значение. <br>Поле актуально в том случае, если из CSV файла количество не загрузилось. <br>Если пустое, то количество товара заноситься не будет.";
$MESS ['parser_catalog_count_default_xls_descr'] = "Поле должно иметь целое числовое значение. <br>Поле актуально в том случае, если из XLS/-X файла количество не загрузилось. <br>Если пустое, то количество товара заноситься не будет.";
$MESS ['parser_header_uniq_field_name'] = "Наименование:";
$MESS ['parser_header_uniq_field_activate'] = "Активировать:";
...
$MESS ['parser_uniq_id'] = "По id из файла:";
$MESS ['parser_uniq_xml_id'] = "По внешнему коду из файла:";
...
$MESS ['parser_uniq_descr_xls'] = "По умолчанию при выгрузке товаров заполняется внешний код XML_ID элемента, как md5(название). Далее при обновлении уникализация осуществляется именно по внешнему коду. <br/><b>Внимание! Если вы не хотите делать запись во внешний код и уникализировать по нему товар, то укажите, по какому полю производить уникализацию элементов. В этом случае внешний код XML_ID затираться не будет.</b>";
...
$MESS ['parser_offer_selector_table'] = "Селектор строки свойств торгового предложения:";
$MESS ['parser_offer_selector_table_descr'] = "Если свойства торгового предложения (например цвет, размер) находятся в нескольких строчках списка или таблиц, <br>
и при этом одно из свойств является выпадающим списком, нужно указать селектор строки для этого списка.<br> Например: <pre>
<table>
    <tr>
        <td><span style='color: black'>1 строка - </span>Цвет: 'Не первой свежести'</td><td>Размер трусов: <select><option>До 100 кг</option><option>Нечто необъятное</option><option>Маааленькая страна...</option></select></td>
    </tr>
    <tr>
        <td><span style='color: black'>2 строка - </span>Цвет: 'Рыжеватый оттенок'</td><td>Размер трусов: <select><option>1</option><option>2</option><option>3</option></select></td>
    </tr>
</table>
</pre>

В противном случае оставить поле пустым. ";
...
$MESS['parser_auth_fail'] = 'Неудачная авторизация. [#CODE#]';
$MESS['parser_auth_fail_server'] = 'Неудачная авторизация. Ошибка сервера. [#CODE#]';
$MESS['parser_auth_fail_client'] = 'Неудачная авторизация. Ошибка клиента. #CODE#';
$MESS['parser_auth_fail_400'] = 'Неудачная авторизация. Неверный запрос. [#CODE#]';
$MESS['parser_auth_fail_401'] = 'Неудачная авторизация. Ключи доступа не подходят. [#CODE#]';
$MESS['parser_auth_fail_403'] = 'Неудачная авторизация. Доступ запрещен к странице обработки формы. [#CODE#]';
$MESS['parser_auth_fail_404'] = 'Неудачная авторизация. Страница не найдена [#CODE#]';
...
$MESS['parser_url_csv_dop'] = 'Дополнительные урлы CSV файлов:';
...
$MESS['parser_url_dop_descr_csv'] = 'Поле предназначено для парса нескольких CSV файлов одновременно. Каждый урл файла пишется с новой строки.';
$MESS['parser_part_xml_descr'] = 'Включение данной функции полезно, если размер оригинального XML файла очень большой!';
$MESS['parser_part_xml'] = 'Делить XML файлы';
...
$MESS["parser_add_delete_symb_props"] = "Добавление/удаление/изменение символов полей и свойств";
...
$MESS["parser_action_props_to_lower"] = "Перевести в нижний регистр";
...
$MESS["parser_offer_parsing_selector_quantity_descr"] = "Если пусто, то количество будет браться из блока Превью или Детально.<br>Если количество товара задается информерами, то соответствия заполняются в разделе \"Работа с информерами наличия\" во вкладке \"Торговый каталог\"";
...
$MESS["parser_offer_one_detail_img"] = "Селектор-атрибут детальной картинки оффера";
$MESS["parser_offer_one_detail_img_descr"] = "Если необходимо создать детальную картинку для торгового предложения. Актуально при парсинге офферов с характеристикой \"Цвет\". Указывается относительно \"Селектор-атрибут детальной картинки оффера\". <br />Например: img[src].";
...
$MESS["parser_type_descr_category_catalog"] = "Тип описания";
...
$MESS["parser_attr_description_section_catalog"] = "Селектор-атрибут, содержащий описание категории";
$MESS["parser_attr_pic_section_catalog"] = "Селектор-атрибут, содержащий изображение категории";
...
$MESS["parser_catalog_file_tab"] = "Разделы";
$MESS["parser_catalog_file_csv"] = "Настройки разделов в файле";
$MESS["parser_catalog_exist_csv"] = "Файл содержит разделы:";
$MESS["parser_catalog_file_csv_descr"] = "Если перед товарами перечисляется структура разделов, то установите данное значение.";
$MESS["parser_catalog_header_csv"] = "Первая строка разделов содержит имена полей:";
$MESS["parser_catalog_file_header_csv_descr"] = "Если первая строка файла представлят собой шапку, то установите данное значение.";
$MESS["parser_catalog_end_csv"] = "Последняя строка разделов:";
$MESS["parser_catalog_file_end_csv_descr"] = "Укажите последнюю строку с разделами начиная отсчет с 1 с самой первой строки файла.";
$MESS["parser_catalog_name_csv"] = "Индекс названия раздела:";
$MESS["parser_attr_id_section_catalog_csv"] = "Индекс, содержащий id раздела:";
$MESS["parser_attr_id_parrent_category_catalog_csv"] = "Индекс, содержащий id родительского раздела:";
$MESS["parser_attr_id_parrent_category_descr_csv"] = "Если пусто, то разделы будут выгружаться без сохранения вложенности.";
$MESS["parser_field_id_category_descr_csv"] = "Указывается поле, в которое будет записан id раздела из csv.";
$MESS["parser_item_category_description"] = "Разделы в товарах:";
$MESS["parser_item_category_csv"] = "Индекс раздела товара:";
$MESS["parser_attr_id_category_descr_csv"] = "Если пусто, то разделы не будут выгружаться.";
$MESS["parser_offer_descr_csv"] = "Парсинг торговых предложений будет разработан и внедрен в последующих версиях решения. Следите за обновлениями.";
$MESS["parser_video_csv"] = "Видеокурс по парсингу CSV скоро будет записан. Следите за обновлениями.";

$MESS["parser_type_descr_xls"] = "По умолчанию парсер настроен для парсинга файлов формата xls/-x.";
$MESS["parser_mode_descr_xls"] = "При debug режиме осуществляется парсинг первых 30 элементов XLS файла. Debug режим необходим для отладки парсера. В рабочий режим парсер необходимо переводить, если вы полностью отладили и настроили парсинг!!!";
$MESS["parser_xls_catalog"] = "URL XLS/-X файла:";
$MESS["parser_url_xls_dop"] = "Дополнительные урлы XLS/-X файлов:";
$MESS["parser_url_dop_descr_xls"] = "Поле предназначено для парса нескольких XLS/-X файлов одновременно. Каждый урл файла пишется с новой строки.";
$MESS["parser_encoding_xls"] = "Кодировка XLS/-X файла, который собираемся парсить. Определяется автоматически. Если не определена, то будет учитываться именно установленное вами значение.";
$MESS["parser_preview_xls_tab"] = "Визуальный редактор";
$MESS["parser_preview_xls"] = "Визуальное отображение файла";
$MESS["parser_load_style"] = "Загружать стили из файла";
$MESS["parser_load_style_xls"] = "Позволяет отметить строки как раздел каталога. Делает визуальный предпросмотр более удобным. Данная опция может замедлить загрузку файла.";
$MESS["XLS_IE_ERROR"] = "Ошибка загрузки файла";
$MESS["parser_save_descr_xls"] = "После изменения URL файла нажмите Применить для отображения нового файла на вкладке Визуальный редактор.";
$MESS["parser_video_xls"] = "Видеокурс по парсингу XLS/-X скоро будет записан. Следите за обновлениями.";
$MESS["parser_load_list_xls"] = "Загружать лист";
$MESS["parser_empty_filename_xls"] = "Для визуального представления файла укажите URL файла и нажмите Применить.";
$MESS["parser_property_el_xls"] = "Свойства элемента";
$MESS["parser_property_catalog_xls"] = "Свойства Торгового каталога";
$MESS["parser_chose_prop"] = "Выберите свойство:";
$MESS["parser_header_uniq_field_category_descr"] = "Описание категорий";
$MESS["parser_header_uniq_field_category_pic"] = "Изображение категорий";
$MESS["parser_header_uniq_field_category_field"] = "Доп. поля категорий";
$MESS["parser_category_fields_category_head"] = "Доп. поля категорий";
$MESS["parser_checkfirst_string_xls"] = "Отметьте строку начала парсинга";
$MESS["parser_submit_index_property"] = "Применить настройки полей";
$MESS["parser_submit_message_xls"] = "После произведения настроек в визуальном редакторе необходимо нажать кнопку \"Применить настройки полей\" для отображения настроек на соответствующих вкладках. Далее возможно произвести более детальную настройку на этих вкладках.";
$MESS["parser_field_id_xls"] = "Индекс колонки, содержащей id товара";
$MESS["parser_name_catalog_xls"] = "Индекс колонки, содержащей названия товара:";
$MESS["parser_name_descr_xls"] = "Если необходимо составить наименование из нескольких частей, то укажите индексы колонок через \",\". Например: 0, 1, 5";
$MESS["parser_preview_price_xls"] = "Индекс колонки, содержащей цену:";
$MESS["parser_preview_count_xls"] = "Индекс колонки, содержащей количества:";
$MESS["parser_xls_text_selector"] = "Индекс колонки, содержащей описание:";
$MESS["parser_preview_text_xls_descr"] = "Если необходимо объеденить несколько колонок, то введите их индексы через \",\". Например \"1, 2, 3\"";
$MESS["parser_preview_first_img_catalog_xls"] = "Индекс колонки, содержащей ссылку на превью картинку:";
$MESS["parser_detail_first_img_catalog_xls"] = "Индекс колонки, содержащей ссылку на детальную картинку:";
$MESS["parser_create_catalog_xls"] = "Создавать разделы из файла/-ов";
$MESS["parser_create_catalog_descr_xls"] = "Отметьте, если Вы хотите создать структуру разделов из файла/-ов и поместить в них товары. Для работы этой опции должна быть включена загрузка стилей из файла.";
$MESS["catalog_level_option_xls"] = "Раздел #LEVEL# уровня";
$MESS["catalog_level_xls"] = "Уровень раздела";
$MESS["parser_max_level_catalog_xls"] = "Максимальная вложенность разделов в файле:";
$MESS["check_catalog"] = "--";
$MESS["catalog_setting_xls"] = "Свойства раздела";
$MESS["change_props_xls"] = "Выберите свойство";
$MESS["parser_catalog_name_not_found"] = "Не задана колонка имени раздела для уровня #LVL#";

$MESS["XLS_IE_FI_SECTION_PATH"] = "Путь из названий разделов";
$MESS['XLS_IE_GROUP_OFFER'] = "Торговое предложение";
$MESS['XLS_IE_GROUP_CATALOG'] = "Каталог";
$MESS['XLS_IE_GROUP_ELEMENT'] = "Элемент";
$MESS['XLS_IE_GROUP_SECTION_LEVEL'] = "Раздел %d уровня";
$MESS['XLS_IE_GROUP_PROP'] = "Свойства";
$MESS['XLS_IE_PROP_DESCRIPTION'] = "описание";

$MESS['XLS_ISECT_FI_NAME'] = "Название раздела";
$MESS['XLS_ISECT_FI_ID'] = "ID раздела";
$MESS['XLS_ISECT_FI_SORT'] = "Сортировка";
$MESS['XLS_ISECT_FI_PICTURE'] = "Изображение (ссылка)";
$MESS['XLS_ISECT_FI_DETAIL_PICTURE'] = "Детальная картинка (ссылка)";
$MESS['XLS_ISECT_FI_DESCRIPTION'] = "Описание";

$MESS['XLS_IE_FI_WEIGHT'] = "Вес (грамм)";
$MESS['XLS_IE_FI_LENGTH'] = "Длина (мм)";
$MESS['XLS_IE_FI_WIDTH'] = "Ширина (мм)";
$MESS['XLS_IE_FI_HEIGHT'] = "Высота (мм)";
$MESS['XLS_IE_FI_QUANTITY'] = "Количество";

$MESS['XLS_IE_FI_UNIXML'] = "Внешний код";
$MESS['XLS_IE_FI_ID'] = "ID элемента";
$MESS['XLS_IE_FI_NAME'] = "Наименование элемента";
$MESS['XLS_IE_FI_DETAIL_LINK'] = "Ссылка на детальную страницу";
$MESS['XLS_IE_FI_CATIMG'] = "Картинка для анонса";
$MESS['XLS_IE_FI_CATIMG_DESCRIPTION'] = "Картинка для анонса (описание)";
$MESS['XLS_IE_FI_CATDESCR'] = "Описание для анонса";
$MESS['XLS_IE_FI_DETIMG'] = "Детальная картинка";
$MESS['XLS_IE_FI_DETIMG_DESCRIPTION'] = "Детальная картинка (описание)";
$MESS['XLS_IE_FI_DETDESCR'] = "Детальное описание";
$MESS['XLS_IE_FI_PARENT_NAME'] = "Название родительской категории";
$MESS['XLS_IE_FI_ACTIV'] = "Активность";
$MESS['XLS_IE_FI_ACTIVFROM'] = "Активность с";
$MESS['XLS_IE_FI_ACTIVTO'] = "Активность до";
$MESS['XLS_IE_FI_SORT'] = "Сортировка";
$MESS['XLS_IE_FI_TAGS'] = "Теги";
$MESS['XLS_IE_FI_CODE'] = "Символьный код";
$MESS['XLS_IE_FI_PRICE'] = "Цена";
$MESS['XLS_IE_FI_MEASURE'] = "Единица измерения";
$MESS['XLS_IE_FI_PRICE_NAME'] = "Цена";
$MESS['XLS_IE_FI_MEASURE_RATIO'] = "Коэффициент единицы измерения";
...
$MESS["parser_mode_descr_csv"] = "При debug режиме осуществляется парсинг первых 30 элементов CSV файла. Debug режим необходим для отладки парсера. В рабочий режим парсер необходимо переводить, если вы полностью отладили и настроили парсинг!!!";
...
$MESS["parser_encoding_csv"] = "Кодировка CSV файла, который собираемся парсить. Определяется автоматически. Если не определена, то будет учитываться именно установленное вами значение. ";
$MESS["parser_mode_descr_yml"] = "По умолчанию парсер настроен для парсинга файлов формата yml.";
$MESS["parser_mode_descr_csv"] = "По умолчанию парсер настроен для парсинга файлов формата csv.";
...
$MESS["parser_store_catalog"] = "Работа со складами";
$MESS["parser_store_list"] = "Склад, на который определять товар:";
$MESS["parser_not_add_to_store"] = "Не добавлять товар на склад";
$MESS["parser_available_quantity"]="Действие с доступным количеством:";
$MESS["parser_not_update"]="Не обновлять";
$MESS["parser_amount_update_from_stores"]="Пересчитать по всем складам";
$MESS["parser_amount_from_file"]="Внести значение из источника";
$MESS["parser_store_amount"]="Количество товара на складе:";
$MESS["nothing"]="Ничего";
$MESS["parser_catalog_count_do_descr"]="Если в списке \"Действие с доступным количеством\" выбран пункт \"Внести значение из источника\", то в доступное количество будет вноситься значение полученное парсером.<br>Если выбран пункт \"Пересчитать по всем складам\", то после занесения товара на склад будет произведен пересчет остатков по всем складам и полученное значение будет внесено в доступное количество.";
$MESS["parser_catalog_stores_descr"]="При выборе склада, в параметр \"Количество товара\" выбранного склада будет вноситься значение из параметра товара \"Доступное количество\".<br>Если в \"Действие с доступным количеством\" выбран пункт \"Пересчитать по всем складам\", то будет внесено значение из источника.<br>При выборе пункта \"Не добавлять товар на склад\" изменение количества товара на складе производиться не будет.";
$MESS["parser_madialibrary"]="Медиабиблиотека для загрузки изображений:";
$MESS["parser_no_select"]="Не выбрано";
$MESS["parser_smart_logs"]="Включить умное логирование:";
$MESS["parser_log_iteration"]="Количество хранимых логов:";
$MESS["parser_field_xml_id_xls"]="Индекс колонки, содержащей внешний код товара";
$MESS["parser_smart_logs_head"]="Умное логирование";
$MESS["parser_log_save_price"]="Сохранять изменения цен:";
$MESS["parser_log_save_count"]="Сохранять изменения количества:";
$MESS["parser_log_save_descr"]="Сохранять изменения детального описания:";
$MESS["parser_log_save_prev_descr"]="Сохранять изменения превью описания:";
$MESS["parser_log_save_img"]="Сохранять изменения детальной картинки:";
$MESS["parser_log_save_prev_img"]="Сохранять изменения превью картинки:";
$MESS["parser_log_save_addit_img"]="Сохранять изменения дополнительных картинок:";
$MESS["parser_log_save_set_catalog"]="Сохранять изменения параметров торгового каталога";
$MESS["parser_class_exists_XMLReader"]="Не подключено расширение XMLReader! Возможны проблемы при парсинге xlsx файлов";
$MESS["parser_exists_libcurl"]="Не подключена библиотека cURL.";
$MESS["parser_offer_load_preview_or_detail"]="Парсить со страницы каталога:";
$MESS["parser_offer_load_preview_or_detail_descr"]="Если установлено, то парсинг торговых происходит со страницы каталога.<br /> В противном случае офферы будут парсится с детальной страницы.";

$MESS["parser_category_main_description"]="Сопоставить с существующими категориями инфоблока";
$MESS["parser_id_category_main"]="ID категории из файла № ";
$MESS["parser_id_category_main_descr"]="Поля предназначены для парсинга товаров в уже существующие разделы инфоблока. Нажмите \"Добавить\" и укажите id категории из файла и раздел инфоблока, в который нужно парсить товар. <br><span style='color: red'><b>Если включено \"Создавать разделы из XML файла\", и список разделов, указанный выше не пустой, то категории из файла создаваться не будут!!!</b></span>";
$MESS["parser_id_category_main_descr_csv"]="Поля предназначены для парсинга товаром в уже существующие разделы инфоблока. Нажмите \"Добавить\" и укажите id категории из файла или название категории из файла в виде \"название родительской категории;название категории\", если отмечен чекбокс \"В товарах указано название раздела из инфоблока\", и раздел инфоблока, в который нужно парсить товар. <br><span style='color: red'><b>Если указано \"Индекс, содержащий id раздела\", и список разделов, указанный выше не пустой, то категории из файла создаваться не будут!!!</b></span>";
$MESS["parser_id_category_main_filter"]="Парсить только товары этих категорий:";
$MESS["parser_id_category_main_filter_descr"]="Если включено, то в инфоблок будут добавлены товары, только из категорий списка, указанного выже.";
$MESS["parser_filter_props"]="Фильтр товаров по свойствам";
$MESS["parser_filter_equally"]="равно";
$MESS["parser_filter_strpos"]="содержит(учитывая регистр)";
$MESS["parser_filter_stripos"]="содержит(без учета регистра)";
$MESS["parser_filter_props_descr"]="При установке фильтров в инфоблок будут добавлены только те товары, которые будут соответсвовать перечисленным условиям. По одному свойству можно добавить только одно условие. Чтобы товар запарсился достаточно выполнение хотя бы одного условия.";

$MESS["parser_props_filter"]="Включить фильтр по свойствам";

$MESS["parser_more_prices"]="Дополнительные цены";
$MESS["shs_parser_add_addit_prices"]="Добавить цену";

$MESS["parser_aditt_currency"]="Валюта для ";

$MESS["parser_availability_informer"]="информер:";
$MESS["parser_availability_count"]="количество:";
$MESS["parser_addit_price_descr"]="На вкладке \"Торговый каталог\" в разделе \"Дополнительные цены\" можно настроить валюту для каждого типа дополнительных цен.";
$MESS["parser_params_image"]="Параметры загрузки изображений";
$MESS["parser_image_ftp"]="Картинки находятся на FTP-сервере:";
$MESS["parser_ftp_login"]="Логин на FTP-сервере:";
$MESS["parser_ftp_password"]="Пароль на FTP-сервере:";
$MESS["parser_ftp_description"]="Отметьте, если картинки расположенны на FTP-сервере";
$MESS["parser_proxy_username"]="Данные для авторизации проски:";
$MESS["parser_proxy_username_descr"]="Укажите прокси-сервер. Пример: 109.194.20.27:3128<br>При необходимости авторизации во второе поле введите логин и пароль в формате \"логин:пароль\".";
$MESS["add_proxy_server"]="Добавить прокси-сервер";
$MESS["delete"]="Удалить";
$MESS["parser_start_header"]="Запуск по агенту";
$MESS["parser_proxy_header"]="Работа с прокси";
$MESS["parser_ftp_login_description"]="Заполните логин и пароль если они не указаны в ссылках";
$MESS["parser_image_in_file"]="Картинки находятся в файле";
$MESS["parser_image_file_description"]="Отметьте если картинки размещены в файле";
$MESS["parser_error_cannot_load_image_from_file"]="Ошибка сохранения изображения из файла";
$MESS["parser_delimiter_image_xls_descr"]="Если ничего не задано, то считается, что в качестве разделителя ссылок используется \",\".<br> Если доп. изображения находятся в файле, то перечислите идексы ячеек в которых они расположены используя указанный разделитель.";
$MESS["parser_catalog_by_name"]="В товарах указано название раздела из инфоблока";
$MESS["parser_catalog_by_name_descr"]="Отметьте, если разделы не парсятся, но в товаре указано название раздела в который его необходимо поместить.";
$MESS["parser_addit_store_descr"]="Если товар необходимо определить на несколько складов, укажите склад и источник.";
$MESS["shs_parser_add_addit_stores"]="Добавить склад";
$MESS["shs_parser_addit_stores"]="Выберите дополнительный склад";
$MESS["parser_addit_store"]="Индекс поля, содержащего кол-ва для склада ";
$MESS["parser_more_stores"]="Дополнительные склады";
$MESS["parser_addit_store_descr_catalog"]="Если товар необходимо определить на несколько складов, укажите склад и источник.<br>!Необходимо указать основной склад на вкладке \"Торговый каталог\"";

$MESS["parser_type_out"]="Куда загружать:";
$MESS["parser_type_out_iblock"]="Инфоблок";
$MESS["parser_type_out_hl"]="Highload-блок";


$MESS["parser_prev_prop_descr"]="Укажите селекторы для парсинга полей.<br>Селектор указывается относительно селектора товара.";
$MESS["parser_field"]="Поле ";
$MESS["parser_hl_props"]="Поля блока";
$MESS["parser_default_fields"]="Значения полей по умолчанию";
$MESS["parser_detail_link_csv"]="Индекс поля, содержащий ссылку на детальную страницу товара:";
$MESS["parser_detail_link"]="Селектор, содержащий ссылку на детальную страницу товара:";
$MESS["parser_offer_from_catalog_tab"]="Торговые предложения с детальной страницы каталога";
$MESS["parser_detail_from_catalog_tab"]="Детальная страница каталога";
$MESS["parser_detail_link_xls"]="Индекс колонки, содержащей ссылку на детальную страницу товара:";
$MESS["parser_detail_from_catalog_properties_tab"]="Свойства с детальной страницы каталога";
$MESS["parser_parser_id_detail"]="ID парсера с настройками детальной страницы:";

$MESS["parser_error_detail_page"]="Отсутствует парсер с настройками детальной страницы.";
$MESS["parser_item_parent_category_csv"]="Индекс родительской категории раздела:";
$MESS["empty_highload_class"]="Не верное имя highload-блока";
$MESS["empty_uniq_fields"]="Не указаны ключевые поля для проверки уникальности";

$MESS["parser_export_not_found_id"]="Не найден ID парсера";
$MESS["parser_export_not_choose_iblock"]="Не выбран инфоблок";
?>