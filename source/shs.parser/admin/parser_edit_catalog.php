...
global $shs_IBLOCK_ID;       //parser_charset_default
...
//global $DB;
//$DB->Query('ALTER TABLE b_shs_parser ADD TYPE_OUT text;');
...
?>  <tr>
    ...
    <?php
    if(isset($shs_SETTINGS['addit_stores_preview']) && !empty($shs_SETTINGS['addit_stores_preview'])){
        foreach($shs_SETTINGS['addit_stores_preview'] as $id_store => $store){
        ?>
    ...
    <tr>
        <td colspan="2" align="center">
            <?=SelectBoxFromArray('arrAdditStores_preview', $arrAdditStores, "", GetMessage("shs_parser_addit_stores"), "");?>
            <input type="submit" id="addStore_preview" name="refresh" value="<?=GetMessage("shs_parser_add_addit_stores")?>">
        </td>
    </tr>
    <tr>
        <td></td>
