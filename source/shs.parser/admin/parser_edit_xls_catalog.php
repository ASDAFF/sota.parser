...
?>
    ...
    <tr>
        <td>
            <span class="required">*</span><?echo GetMessage("parser_iblock_id_catalog")?>
        </td>
        <td>
            <?=SelectBoxFromArray('IBLOCK_ID', $arIBlock, $shs_IBLOCK_ID, GetMessage("parser_iblock_id"), "id='iblock' style='width:262px' ");?>
        </td>
    </tr>
    <tr>
        <td></td>
                ...
                if(isset($shs_RSS)) {
                    ...
                    foreach($worksheets as $key=>$wsh){
                        ...
                        echo '<div style="overflow: auto;">
                                ...
                                $utils->printHtmlTable($wsh['lines'],true, $param, $shs_IBLOCK_ID, $key, true);
                        echo "</div>";
                    }
                } else { ?>
                    <?=BeginNote();?>
...
?>
    ...
    <tr>
        <td class="field-name" width="40%"><?echo GetMessage("parser_detail_link_xls")?></td>
...
?>
   ...
   <tr>
    ...
    <tr>
        ...
        <td width="60%">
            <?=SelectBoxFromArray('SETTINGS[xls_catalo][auth][type]', $arAuthType, $shs_SETTINGS["xls_catalo"]["auth"]["type"], "", "class='select_load'");?>
        </td>
    </tr>
    <tr>
        <td width="40%"><?echo GetMessage("parser_auth_active")?></td>
        <td width="60%"><input type="checkbox" name="SETTINGS[xls_catalo][auth][active]" value="Y"<?if($shs_SETTINGS["xls_catalo"]["auth"]["active"] == "Y") echo " checked"?>></td>
    </tr>
    <?if((isset($shs_SETTINGS["xls_catalo"]["auth"]["type"]) && $shs_SETTINGS["xls_catalo"]["auth"]["type"]=="form") || !isset($shs_SETTINGS["xls_catalo"]["auth"]["type"])):?>
    <tr>
        <td width="40%"><?echo GetMessage("parser_auth_url")?></td>
        <td width="60%"><input type="text" size="40" name="SETTINGS[xls_catalo][auth][url]" value="<?=$shs_SETTINGS["xls_catalo"]["auth"]["url"]?>"></td>
    </tr>
    <tr>
        <td></td>
        <td>
    ...
    <tr>
        ...
        <td width="60%"><input type="text" size="40" name="SETTINGS[xls_catalo][auth][selector]" value="<?=$shs_SETTINGS["xls_catalo"]["auth"]["selector"]?>"></td>
    </tr>
    <tr>
        <td width="40%"><?echo GetMessage("parser_auth_login")?></td>
        <td width="60%"><input type="text" size="40" name="SETTINGS[xls_catalo][auth][login]" value="<?=$shs_SETTINGS["xls_catalo"]["auth"]["login"]?>"> <?echo GetMessage("parser_auth_login_name")?> <input type="text" size="20" name="SETTINGS[xls_catalo][auth][login_name]" value="<?=$shs_SETTINGS["xls_catalo"]["auth"]["login_name"]?>"></td>
    </tr>
    <tr>
        <td width="40%"><?echo GetMessage("parser_auth_password")?></td>
        <td width="60%"><input type="text" size="40" name="SETTINGS[xls_catalo][auth][password]" value="<?=$shs_SETTINGS["xls_catalo"]["auth"]["password"]?>"> <?echo GetMessage("parser_auth_password_name")?> <input type="text" size="20" name="SETTINGS[xls_catalo][auth][password_name]" value="<?=$shs_SETTINGS["xls_catalo"]["auth"]["password_name"]?>"></td>
    </tr>
    <tr>
        <td></td>
        <td>
    ...
    <tr>
        <td width="40%"><?echo GetMessage("parser_auth_login")?></td>
        <td width="60%"><input type="text" size="40" name="SETTINGS[xls_catalo][auth][login]" value="<?=$shs_SETTINGS["xls_catalo"]["auth"]["login"]?>"></td>
    </tr>
    <tr>
        <td width="40%"><?echo GetMessage("parser_auth_password")?></td>
        <td width="60%"><input type="text" size="40" name="SETTINGS[xls_catalo][auth][password]" value="<?=$shs_SETTINGS["xls_catalo"]["auth"]["password"]?>"></td>
    </tr>
    <?endif;?>
    <?if($shs_SETTINGS["xls_catalo"]["auth"]["type"]=="form"):?>
    <tr>
        <td width="40%"></td>
