...
?>
    ...
    <tr>
        <td class="field-name" width="40%"><?echo GetMessage("parser_detail_link_csv")?></td>
...
?>
   ...
   <tr>
    ...
    <tr>
        ...
        <td width="60%"><input type="text" name="SETTINGS[offer][catalog_offer_selector_table]" value="<?echo $shs_SETTINGS["offer"]["catalog_offer_selector_table"];?>" size="40" maxlength="250"></td>
    </tr>
    <tr>
        <td class="field-name" width="40%"></td>
        <td width="60%">
